  ...
  <div class="col-md-12">
    ...
    <div class="widget-content">
        ...
        <div class="row">
            ...
            <form:select path="dropDown1" id="selectClient" class="form-control">
            ...
            <div class="col-md-3">
                <br/>
                <button id="showBtn" class="btn btn-primary " onclick="getClientAddressInfo()" ><i class="fa fa-globe"></i>Show</button>
            </div>
        </div>
        <br/>
        <div id="gmap-default" style="height: 400px;">
...
<script src="js/clientMap.js"></script>
