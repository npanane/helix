       ...
       <div class="widget-content">
          <div class="row">
              <div style="padding: 10px" >
                  <div  style="width:100%; height:100px;background-color:#ffffff;" id="springPOBoxGridbox"> </div>
        ...
        <div class="col-md-12">
            <div class="widget widget-blue">
                ...
                <div class="widget-content">
                    <div class="row">
                        <div style="padding: 10px" >
                            <div  style="width:100%; height:100px;background-color:#ffffff;" id="fallPOBoxGridbox"> </div>
                        </div>
...
<script src="js/poBoxReShips.js"></script>
