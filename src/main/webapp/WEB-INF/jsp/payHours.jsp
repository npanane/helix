...
<div class="main-content" style="margin-left: 60px;">
   ...
   <div class="row">
       ...
       <div class="widget-content">
          <div class="row">
              <div style="padding: 10px" >
                  ...
                  <div class="btn btn-primary btn-sm" id="AddNewReferenceInfoBtn" data-toggle="modal" data-target="#createNewReference"><i class="fa fa-user"></i>Add New Reference</div>
                  <div class="btn btn-success btn-sm" id="ReferenceInfoEditBtn" data-toggle="modal" data-target="#editReference"><i class="fa fa-edit"></i>Edit</div>
                  <button id="ReferenceInfoDeleteBtn" class="btn btn-danger btn-sm" onclick="deleteReferenceInfo()"><i class="fa fa-trash-o"></i>Delete</button>
    ...
    <div class="row">
        ...
        <div class="col-md-11">
            <a href="references/print" target="_blank" class="btn btn-action btn-success btn-sm" ><i class="fa fa-print"></i>Print</a>
...
<script src="js/payHours.js"></script>
