...
function populateSpringPOBoxGrid() {
    ...
    $.ajax({type:'GET',
        url: 'poBoxPickUps/loadSpringPOBoxInfo',
...
function doOnEditCell(stage,rowId,cellIndex,newValue,oldValue){
    if ((stage==2)&&(newValue!=oldValue)){
        ...
        if(cellIndex==2){
            ...
            $.ajax({
                url: 'poBoxPickUps/editSPhoneNumber',
        ...
        if(cellIndex==3){
            ...
            $.ajax({
                url: 'poBoxPickUps/editSContactName',
...
function populateFallPOBoxGrid() {
    ...
    $.ajax({type:'GET',
        url: 'poBoxPickUps/loadFallPOBoxInfo',
        success: function(data) {
...
function doOnEditCell2(stage,rowId,cellIndex,newValue,oldValue){
    if ((stage==2)&&(newValue!=oldValue)){
        ...
        if(cellIndex==2){
            ...
            $.ajax({
                url: 'poBoxPickUps/editFPhoneNumber',
                data: ({phoneNo:phoneNo,userName:userName,rowId:rowId}),
                success: function(id) {
                }
            });
        ...
        if(cellIndex==3){
            ...
            $.ajax({
                url: 'poBoxPickUps/editFContactName',
                data: ({contactName:contactName,userName:userName,rowId:rowId}),
                success: function(id) {
                }
            });
